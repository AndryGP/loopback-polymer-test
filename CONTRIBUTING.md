...
Thank you for your interest in `loopback2.0_example_extendedAPI`, an open source project
administered by StrongLoop.

Contributing to `loopback2.0_example_extendedAPI` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/loopback-example-extendedAPI)
